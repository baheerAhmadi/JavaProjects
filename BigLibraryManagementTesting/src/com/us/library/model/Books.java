...
public class Books {
	...
	public Books(long book_id, String bookname, String description, String author, Double price,
			long categoryid, long quantity, boolean isActive, long updatedby, Date updatedon,
			BooksCategory bookscategory, LendingBooks lendingbooks) {
		super();
